...
int F_generic(const T** arg, T** res) {
	...
	st_pin2[0].setCoordinateNames(OpenSim::Array<std::string>("r4_z", 1, 1));
	st_pin2[0].setFunction(new LinearFunction());
	st_pin2[0].setAxis(Vec3(0, 0, 1));
	st_pin2[1].setCoordinateNames(OpenSim::Array<std::string>("r5_x", 1, 1));
	st_pin2[1].setFunction(new LinearFunction());
	st_pin2[1].setAxis(Vec3(1, 0, 0));
	st_pin2[2].setCoordinateNames(OpenSim::Array<std::string>("r6_y", 1, 1));
	st_pin2[2].setFunction(new LinearFunction());
	st_pin2[2].setAxis(Vec3(0, 1, 0));
	pin2 = new CustomJoint("pin2", *pend1, Vec3(0, -0.4265, 0),
		Vec3(0), *pend2, Vec3(0, 0.3, 0), Vec3(0),st_pin2);
